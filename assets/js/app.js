...
document.addEventListener('DOMContentLoaded', () => {
  ...
  openFibHero && openFibHero.addEventListener('click', ()=> openModal('pages/forex-tools/fib-calculator.html'));
  ...
  document.querySelectorAll('.card').forEach(card => {
    card.addEventListener('click', (e) => {
      ...
      // if the card has a data-href attribute (works for the first fib card)
